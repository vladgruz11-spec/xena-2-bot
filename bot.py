...
def video_settings_menu(mode):
    keyboard = [
        ...
        [InlineKeyboardButton("✍️ Описание", callback_data=f"{mode}_prompt")],
        [InlineKeyboardButton("🖼 Исходные картинки", callback_data=f"{mode}_ref_images")],
        [InlineKeyboardButton("🎬 Исходное видео", callback_data=f"{mode}_ref_videos")],
        [InlineKeyboardButton("🎵 Исходное аудио", callback_data=f"{mode}_ref_audio")],
